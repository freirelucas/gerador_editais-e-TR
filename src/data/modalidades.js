...
// `formacao`: forma curta da titulação (exibida no card).
// `perfilBase`: sintagma que ABRE o perfil composto — precisa encaixar em
//   "{perfilBase}, com {competências}, com atuação em {tema} (…)." (usado por lib/perfil).
export const MODALIDADES = [
  {
    ...
    perfilBase: "Estudante de graduação com matrícula regular",
  },
  {
    ...
    perfilBase: "Profissional com graduação concluída",
  },
  {
    ...
    perfilBase: "Profissional com título de mestre, especialista ou experiência equivalente em pesquisa",
  },
  {
    ...
    perfilBase: "Profissional com graduação concluída e conhecimentos em ciência de dados",
  },
  {
    ...
    perfilBase: "Profissional com graduação e pós-graduação (lato ou stricto sensu)",
  },
  {
    ...
    perfilBase: "Profissional com título de doutor",
  },
  {
    ...
    perfilBase: "Docente ou pesquisador(a) de instituição estrangeira",
  },
  {
    ...
    perfilBase: "Pesquisador(a) convidado(a), em regime de serviço voluntário",
  },
];
